...
def beet_default(ctx: Context):
    ...
    ctx.assets["minecraft:block/dice_white/1"] = Texture(dice_sides[1])
    ctx.assets["minecraft:block/dice_white/2"] = Texture(dice_sides[2])
    ctx.assets["minecraft:block/dice_white/3"] = Texture(dice_sides[3])
    ctx.assets["minecraft:block/dice_white/4"] = Texture(dice_sides[4])
    ctx.assets["minecraft:block/dice_white/5"] = Texture(dice_sides[5])
    ctx.assets["minecraft:block/dice_white/6"] = Texture(dice_sides[6])
